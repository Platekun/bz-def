...
import { IConnectorAction } from '../@types/app/IConnectorAction';
 ...
 */
export function getActions(actions: IConfigActionInfo[]): string {
    const actionsDefinition = actions.map((action: IConfigActionInfo) => 
